...
#define JUCE_IOS_API_VERSION_MIN_REQUIRED_AT_LEAST(major, minor) \
  ...
  #if JUCE_MAC
    #if ! JUCE_MAC_API_VERSION_CAN_BE_BUILT (10, 13)
      #error "The macOS 10.13 SDK (Xcode 12.4+) is required to build JUCE apps. You can create apps that run on macOS 10.11+ by changing the deployment target."
